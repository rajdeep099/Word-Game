...
def start():
    ...
    alphabets = ['ABSOLUTE','ENERGY','DATABASE','BUILDING','SPROUT','ESCAPE','AUDIENCE','DAILY','CALENDAR','SPACE','FAMILY','DAIBETES','ATTACK','LAUNCH','BACTERIA','SOLUTION','FATHER','MOTHER','BIRTHDAY','GARDEN','COMPUTER','GREEN','CEREMONY']
...
def restart():
    ...
    for i in range (2):
        ...
        turtle.right(90)
    turtle.penup()
    turtle.setposition(-30,-330)
    turtle.pendown()
    turtle.write('PLAY',font=('Arial',16,'bold'))      
